...
//            mAuthTask.execute((Void) null);
            url.addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                 String   stringForEmail = email.replaceAll("\\.",",");
                 if(dataSnapshot.child(stringForEmail).exists()){
                  String stringForPassword =   dataSnapshot.child(stringForEmail).child("password").getValue().toString();
                  if(stringForPassword.equals(password)){
                     ...
                     Toast.makeText(LoginActivity.this,"not registered user",Toast.LENGTH_SHORT).show();
                 }
                }
